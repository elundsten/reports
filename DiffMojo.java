...
public class DiffMojo extends BaseMojo {
    ...
    private DirectedGraph<String> eriksSuperGraph;
    ...
    protected void setGraphErik(DirectedGraph<String> eriksGraph) throws MojoExecutionException {
        eriksSuperGraph = eriksGraph;
    }
    protected DirectedGraph<String> getGraphErik() throws MojoExecutionException {
        return eriksSuperGraph;
    }
